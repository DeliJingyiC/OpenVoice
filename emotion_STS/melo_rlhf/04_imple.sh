...
bash train.sh /home/ubuntu/OpenVoice/emotion_STS/melo_rlhf/data/example/config.json 8
bash /home/ubuntu/OpenVoice/MeloTTS/melo/train.sh /home/ubuntu/OpenVoice/MeloTTS/melo/logs/configs/config.json 1

###NISQA
python run_predict.py --mode predict_dir --pretrained_model weights/nisqa.tar --data_dir /home/ubuntu/OpenVoice/emotion_STS/melo_emo/logs_experiment3/example/evaluation --num_workers 0 --bs 10 --output_dir /home/ubuntu/OpenVoice/emotion_STS/melo_emo/logs_experiment3/example/evaluation
