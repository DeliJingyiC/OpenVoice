...
########emotionalstartgan
    ...
    wav, sr = librosa.load('/home/ubuntu/OpenVoice/emotion_STS/melo_emo/eval_input_audio/real/0011_000852_happy.wav', 16000)
    wav1, sr1 = librosa.load('/home/ubuntu/OpenVoice/emotion_STS/melo_emo/eval_input_audio/real/0011_000488_angry.wav', 16000)
    y = process_func(np.expand_dims(wav, 0), sr, embeddings=True)[0]
