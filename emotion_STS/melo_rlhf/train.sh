...
CHECKPOINT_DIR="/home/ubuntu/OpenVoice/emotion_STS/melo_rlhf/logs_emo/example"
...
torchrun --nproc_per_node=$GPUS \
        --master_port=$PORT \
    /home/ubuntu/OpenVoice/emotion_STS/melo_rlhf/train.py --c $CONFIG --model $MODEL_NAME  --pretrain_G $CHECKPOINT_DIR --pretrain_D $CHECKPOINT_DIR --pretrain_dur $CHECKPOINT_DIR --pretrain_rl /home/ubuntu/OpenVoice/emotion_STS/melo_rlhf/pretrained_RL_emo/example
