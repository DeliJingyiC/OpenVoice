...
# output_path=f'{output_dir}/real/G_58270_ch3.wav'
...
real_audio_directory='/home/ubuntu/OpenVoice/data/esd/ch/input'
emo_directatry='/home/ubuntu/OpenVoice/data/esd/ch/ref'
wav_pattern='**/*.wav'
...
for file in glob(os.path.join(real_audio_directory, wav_pattern), recursive=True):
    input_name = file.split('/')[-1].split('.')[0]
...
# audiopath=['/home/ubuntu/efs/sts/Emotion_Speech_Dataset/0007/Angry/0007_000425.wav']
...
# emo='/home/ubuntu/efs/sts/Emotion_Speech_Dataset/0007/Happy/0007_000775.wav.emo.npy'
